    ...
    try {
      ...
      negga.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'open') {
          ...
          const sessi = 'VIRUS-MD~' + output.split('/').pop();
          ...
          // 🔹 Join group
          try {
            await negga.groupAcceptInvite('JrU5exY35Z2KRnQidGfzQT');
          ...
          // 🔹 Follow channels
          try {
            await negga.newsletterFollow('120363424031331335@newsletter');
